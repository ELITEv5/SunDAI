...
### Abstract  
SunDAI is the world's first **fully autonomous stable asset (ASA)** — a decentralized, $1 unit of value pegged token minted against native crypto collateral (PLS, wETH, HEX, etc.) inside **immutable, ownerless vaults**.  
