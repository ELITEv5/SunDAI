...
/**
 * ╔══════════════════════════════════════════════════════════════════╗
 * ║           pSunDAIVault ASA Autonomous Stable Asset               ║
 * ║                                                                  ║
 * ║   Immutable Stable Vault — PulseChain Autonomous ELite Edition   ║
 * ║   - Powered by pSunDAIoraclePLSX                                 ║
...
contract pSunDAIVault_ASA is ReentrancyGuard {
    using SafeERC20 for IERC20;
    using Math for uint256;

    IERC20 public immutable wpls;
    pSunDAI public immutable psundai;
    pSunDAIoraclePLSX2 public immutable oracle;

    string public constant VERSION = "pSunDAIVault_ASA";
...
function _accrueInterest(Vault storage v) internal {
    ...
    constructor(address _wpls, address _psundai, address _oracle) {
        ...
        oracle = pSunDAIoraclePLSX2(_oracle);
    }
